...
// delim, and flush.
//
// [connect.c::send_capabilities lines 490-516]: https://github.com/git/git/blob/v2.54.0/connect.c#L490-L516
// [connect.c:97]: https://github.com/git/git/blob/v2.54.0/connect.c#L97
