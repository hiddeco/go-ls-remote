...
//
// The body grammar matches [gitprotocol-v2.adoc §"object-info" lines 556-585]:
// `command=object-info`, capability echo, `0001` delim, then
...
// [send_info:44-45]: https://github.com/git/git/blob/v2.54.0/protocol-caps.c#L44-L45
...
// [send_info:66-67]: https://github.com/git/git/blob/v2.54.0/protocol-caps.c#L66-L67
// [gitprotocol-v2.adoc §"object-info" grammar (lines 573-585)]: https://github.com/git/git/blob/v2.54.0/Documentation/gitprotocol-v2.adoc?plain=1#L573-L585
